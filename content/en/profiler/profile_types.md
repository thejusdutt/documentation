...
Allocations
: The number of allocations by each function during the profiling period, including allocations which were subsequently freed. Stack allocations are not tracked.

Allocated memory
: The amount of heap memory allocated by each function during the profiling period, including allocations which were subsequently freed. Stack allocations are not tracked.
